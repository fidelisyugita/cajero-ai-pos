...
export const AI_MODELS: Record<AIModelType, AIModelConfig> = {
  "llama-3.2-1b": {
    ...
    downloadUrl:
      "https://huggingface.co/executorch-community/Llama-3.2-1B-ET/resolve/main/llama3_2-1B.pte?download=true",
  ...
  "stories-110m": {
    ...
    downloadUrl:
      "https://huggingface.co/executorch/stories_110m/resolve/main/stories110M.pte?download=true",
