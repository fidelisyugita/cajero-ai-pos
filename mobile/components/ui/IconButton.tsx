...
const getButtonStyles = (theme: Theme, state: "default" | "pressed" | "disabled") => {
  const { colors } = theme;
...
const getButtonIconStyles = (theme: Theme, state: "default" | "pressed" | "disabled") => {
  const { colors } = theme;
  const stateStyles = {
    default: {
...
const IconButton = ({ variant, size = "md", Icon, style, ...rest }: IconButtonProps) => {
