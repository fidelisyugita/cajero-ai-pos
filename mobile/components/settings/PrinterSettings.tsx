...
const PrinterSettings = () => {
  ...
  }, [isConnected, handleConnect, connectedDevice]);

  return (
    <FormSectionCard title={t("printer_setting")} style={{ flex: 1 }} contentStyle={$.container}>
      {/* Auto Print Setting */}
      <View>
        <View style={$.rowBetween}>
          ...
          <Switch value={isAutoPrintEnabled} onValueChange={setIsAutoPrintEnabled} />
        </View>
      </View>
      ...
      {connectedDevice && (
        <View style={$.section}>
          <Text style={$.sectionTitle}>
            {isConnected ? t("connected_printer") : t("default_printer")}
          </Text>
      ...
      <View style={$.section}>
        ...
        <FlatList
          ...
          contentContainerStyle={[
            $.listContainer,
            devices.length === 0 && { flex: 1, justifyContent: "center" },
          ]} // Center empty state
          ListEmptyComponent={
            isScanning ? (
